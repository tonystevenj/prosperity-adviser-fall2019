...
class FullProcess:
    def __init__(self, fPath,toFileNames):
        ...
        besinessID = corpus[0]
        text = corpus[1]
        words, weights = self.my_TF_IDF(text)
        self.my_process_for_IFIDF(besinessID, words, weights)

    def my_TF_IDF(self, text):
    ...
    def my_process_for_IFIDF(self, besinessID, words, weights):
